...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qy3c5i.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qy3c5i.containers.anotherwebservice.com/
...
```
git clone git@github.com:RohitKushvaha01/container-qy3c5i.git
cd container-qy3c5i
```
...
```
docker attach container-qy3c5i
```
